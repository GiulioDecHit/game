...
function controllaNuovaPosizione() {
	...
	// si sbianca la cella per dare l'impressione che l'omino abbia raccolto la
	// pillola
	...
	// se nella cella c'è l'arma allora il valore della immagine da visualizzare
	// cambia
	...
	// se il contatore pillole è zero vuol dire che il giocatore le ha raccolte
	// tutte.
	if (countPillole == 0) {
		document.getElementById("energia").innerHTML = "<img src="+ imgPath+"coppa.jpg>";
