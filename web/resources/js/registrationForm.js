...
function checkSex(){
    ...
    var sexM = document.getElementById("spanM");

    if((sexM.queryCommandState("::after").isPresenting)){
         return x.set("M");
    }else{
        return x.set("F");
    }
...
function InviaForm() {
    ...
    if (thereIsCF.value == "CODICE FISCALE (automatico)"
        ...
        var calculateCF = document.getElementById("calculateCF");
        alert(calculateCF);
        ...
        var submit = document.getElementById("modulo");
...
function checkIfAlreadyValid(element) {
    var elementTarget = document.getElementById(element);
...
function makeSeeable(elementString) {
    ...
    if (textPass.type === "password") {
        ...
        imgPass.src = pathImgn + "openedEye.png";
    }
}
...
function makeBlind(elementString) {
    ...
    if (textPass.type === "text") {
        ...
        var imgPass = document.getElementById(elementString + "Img");
        imgPass.src = pathImgn + "closedEye.png";
    }
}
    ...
    if (document.getElementById("pippo").innerText == "true") {
        if ((!(codice.toUpperCase().includes("ERROR")))
            ...
            if (document.getElementById("name").value == "") {
                document.getElementById("name").style.border = "8px solid #FF0000";
                datiDaCompilare += "\n * Nome";
            }
            if (document.getElementById("surname").value == "") {
                document.getElementById("surname").style.border = "8px solid #FF0000";
                datiDaCompilare += "\n * Cognome";
            }
            if (document.getElementById("dateOfBirth").value == "") {
                document.getElementById("dateOfBirth").style.border = "8px solid #FF0000";
                datiDaCompilare += "\n * Data di nascita";
            }
            if (document.getElementById("modulo").placeOfBirth.value == ""
                || codice.toUpperCase().includes("ERROR")) {
                document.getElementById("placeOfBirth").style.border = "8px solid #FF0000";
                datiDaCompilare += "\n * Luogo di nascita";
                if (codice.toUpperCase().includes("ERROR")
                    && !document.getElementById("placeOfBirth").value == "")
                    datiDaCompilare += ": COMUNE SCONOSCIUTO!";
                if (document.getElementById("placeOfBirth").isAlreadyValid) {
                    indice -= 10;
                    battery(indice);
                    document.getElementById("fiscalCode").isAlreadyValid = false;
                }
            }
            alert("Compila i dati necessari per il CF" + datiDaCompilare);
            document.getElementById("fiscalCode").style.border = "8px solid #FF0000";
        }
    }
...
function writeInFiscalCode(toWrite) {
    document.getElementById("fiscalCode").style.border = "8px solid #008000";
    if (!document.getElementById("fiscalCode").isAlreadyValid) {
        indice += 10;
        battery(indice);
        document.getElementById("fiscalCode").isAlreadyValid = true;
    }
    document.getElementById("fiscalCode").value = toWrite;
}
